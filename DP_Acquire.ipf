...
//	Wave testPulseTTL=SimplePulse(sinttp,0.5*tpdur,tpdur,0.5*tpdur,tpamp)
//		
//	// return
//	return testPulse
//End
...
//	
//	// Generate the (free) wave
//	Wave testPulseTTL=SimplePulseBoolean(sinttp,0.5*tpdur,tpdur,0.5*tpdur)
//		
//	// Restore the DF
//	SetDataFolder savedDF
//	
...
//	if (cmpstr(S_value,"stepPulse")==0)			//if the stim is a "step pulse"...
