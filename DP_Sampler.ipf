...
Function SamplerSampleDataStart(adSequence,daSequence,FIFOout)
	// Start the data acquisition.  This sets the digitizer in motion, then returns.
	// Generally, the acquired data is read some time later using SamplerSampleDataFinishBang()
	String adSequence
	String daSequence
	Wave FIFOout
